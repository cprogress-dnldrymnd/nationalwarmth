	...
	<div class="header-bottom-holder background-secondary">
		<div class="container-fluid">
			<ul class="d-flex justify-content-center align-items-center list-inline row mb-0 fw-light g-0 flex-wrap flex-lg-nowrap">
				...
				<li class="col-lg-auto col-md-4 col-6">
					<a href="https://nationalwarmth.co.uk/services/air-source-heat-pumps/" class="d-flex align-items-center justify-content-center text-white flex-column flex-lg-row h-100">
						<span class="icon"><img src="/wp-content/uploads/2022/07/heat-pumps-1.png" alt=""></span>
						<span class="text">Heat Pumps</span>
					</a>
				</li>
				<li class="col-lg-auto col-md-4 col-6">
					<a href="https://nationalwarmth.co.uk/services/solar-power/" class="d-flex align-items-center justify-content-center text-white flex-column flex-lg-row h-100">
				...
				<li class="col-lg-auto col-md-4 col-6">
					<a href="https://nationalwarmth.co.uk/services/eco4-boiler-upgrade-grant/" class="d-flex align-items-center justify-content-center text-white flex-column flex-lg-row h-100">
